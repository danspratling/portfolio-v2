  ...
  return (
    <div
      className={cn(
        ...
        // colors
        selectedColor === "gray" && "bg-gray-950 text-gray-300 border-gray-800", //"bg-gray-50 text-gray-700 border-gray-200 dark:bg-gray-950 dark:text-gray-300 dark:border-gray-800",
        selectedColor === "red" && "bg-red-950 text-red-300 border-red-800", //"bg-red-50 text-red-700 border-red-200 dark:bg-red-950 dark:text-red-300 dark:border-red-800",
        ...
        selectedColor === "lime" && "bg-lime-950 text-lime-300 border-lime-800",
        ...
        selectedColor === "teal" && "bg-teal-950 text-teal-300 border-teal-800",
        // "bg-teal-50 text-teal-700 border-teal-200 dark:bg-teal-950 dark:text-teal-300 dark:border-teal-800",
        selectedColor === "cyan" && "bg-cyan-950 text-cyan-300 border-cyan-800",
        // "bg-cyan-50 text-cyan-700 border-cyan-200 dark:bg-cyan-950 dark:text-cyan-300 dark:border-cyan-800",
        selectedColor === "sky" && "bg-sky-950 text-sky-300 border-sky-800",
        // "bg-sky-50 text-sky-700 border-sky-200 dark:bg-sky-950 dark:text-sky-300 dark:border-sky-800",
        selectedColor === "blue" && "bg-blue-950 text-blue-300 border-blue-800",
        ...
        selectedColor === "pink" && "bg-pink-950 text-pink-300 border-pink-800",
        // "bg-pink-50 text-pink-700 border-pink-200 dark:bg-pink-950 dark:text-pink-300 dark:border-pink-800",
        selectedColor === "rose" && "bg-rose-950 text-rose-300 border-rose-800",
